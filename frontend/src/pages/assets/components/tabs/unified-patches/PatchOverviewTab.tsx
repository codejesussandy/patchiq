...
import type { AssetRelatedPatch, PatchSummary } from '../../../../../types/asset.types';
import { CHART_COLORS } from './patchHelpers';

const { Text } = Typography;

interface PatchOverviewTabProps {
  patchSummary: PatchSummary | null;
  patches: AssetRelatedPatch[];
}

export const PatchOverviewTab = ({ patchSummary, patches }: PatchOverviewTabProps) => {
