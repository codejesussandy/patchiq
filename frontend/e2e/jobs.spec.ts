...
test.describe('Jobs Module', () => {
  ...
  test.describe('Configuration Jobs Page', () => {
    test('should navigate to configuration jobs', async ({ page }) => {
      await page.goto('/jobs/configuration-jobs/catalog');
      await waitForPageLoad(page);
    ...
    test('should display configuration jobs table', async ({ page }) => {
      await page.goto('/jobs/configuration-jobs/catalog');
      await waitForPageLoad(page);
      await checkTableRendered(page);
    });
  ...
  test.describe('Patch Jobs Page', () => {
    test('should navigate to patch jobs', async ({ page }) => {
      await page.goto('/jobs/patch-jobs');
      await waitForPageLoad(page);
  ...
  test.describe('Vulnerability Jobs Page', () => {
    test('should navigate to vulnerability jobs', async ({ page }) => {
      await page.goto('/jobs/vulnerability-jobs/catalog');
      await waitForPageLoad(page);
