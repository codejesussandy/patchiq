...
async function test1_verifyAuth(page) {
...
async function test2_navigateToVulnerabilities(page) {
...
async function test3_testSearch(page) {
...
async function test4_testSeverityFilter(page) {
...
async function test5_testEPSSFilter(page) {
...
async function test6_testSorting(page) {
...
async function test7_testPagination(page) {
...
async function test8_testCVEDetail(page) {
...
async function test9_testScanModal(page) {
...
async function test10_testDashboardStats(page) {
